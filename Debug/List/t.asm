...
; 0000 0008 #asm("sei")
	SEI
; 0000 0009 lcd_twi_init(PCF8574_I2C_ADDRESS,16);
	LDI  R30,LOW(39)
	ST   -Y,R30
	LDI  R26,LOW(16)
	RCALL _lcd_twi_init
; 0000 000A lcd_printfxy(0,1,"Hello world");
	LDI  R30,LOW(0)
	ST   -Y,R30
	LDI  R30,LOW(1)
	ST   -Y,R30
...
_0x3:
; 0000 000C {
; 0000 000D lcd_printfxy(0,0,"%u",n);
	LDI  R30,LOW(0)
	ST   -Y,R30
	ST   -Y,R30
	__POINTW1FN _0x0,12
